...
function showContent(sectionId) {
    ...
    navLinks.forEach(link => {
        ...
        link.classList.remove('text-white'); // Menghapus text-white
        link.classList.add('text-primary');  // Menambahkan text-primary

        // Temukan elemen <span> di dalam link dan ubah kelasnya
        const spanElement = link.querySelector('span');
        if (spanElement) {
            spanElement.classList.remove('text-white'); // Menghapus text-white
            spanElement.classList.add('text-primary');  // Menambahkan text-primary
        }
    });
        ...
        .then(data => {
            ...
            data.forEach((karyawan) => {
                ...
                row.innerHTML = `
                    ...
                    <td>
                        <button class="btn btn-info btn-sm" onclick="viewKaryawan('${karyawan.kode}')"><i class="fas fa-eye"></i></button>
                        <button class="btn btn-warning btn-sm" onclick="editKaryawan('${karyawan.kode}')"><i class="fas fa-edit"></i></button>
                        <button class="btn btn-danger btn-sm" onclick="deleteKaryawan('${karyawan.kode}')"><i class="fas fa-trash"></i></button>
                    </td>
                `;
        ...
        .then(data => {
            ...
            data.forEach((karyawan) => {
                ...
                row.innerHTML = `
                    ...
                    <td>
                        <button class="btn btn-info btn-sm" onclick="viewKaryawan('${karyawan.kode}')"><i class="fas fa-eye"></i></button>
                        <button class="btn btn-danger btn-sm" onclick="deleteJabatan('${karyawan.kode}')"><i class="fas fa-trash"></i></button>
                    </td>
                `;
                tableBody.appendChild(row);
            });
        ...
        .then(data => {
            ...
            data.forEach((karyawan) => {
                ...
                row.innerHTML = `
                    ...
                    <td>
                        <button class="btn btn-info btn-sm" onclick="viewKaryawan('${karyawan.kode}')"><i class="fas fa-eye"></i></button>
                        <button class="btn btn-danger btn-sm" onclick="deleteDivisi('${karyawan.kode}')"><i class="fas fa-trash"></i></button>
                    </td>
                `;
                tableBody.appendChild(row);
            });
        ...
        .then(data => {
            ...
            data.forEach((absen) => {
                ...
                row.innerHTML = `
                    ...
                    <td>
                        <button class="btn btn-info btn-sm" onclick="viewKaryawan('${absen.no}')"><i class="fas fa-eye"></i></button>
                        <button class="btn btn-danger btn-sm" onclick="deleteDivisi('${absen.no}')"><i class="fas fa-trash"></i></button>
                    </td>
                `;
                tableBody.appendChild(row);
            });
        ...
        .then(data => {
            ...
            data.forEach((liIzin) => {
                ...
                row.innerHTML = `
                    ...
                    <td>
                        <button class="btn btn-warning btn-sm" onclick="ubahStatusIzin(${liIzin.no})"><i class="fas fa-edit"></i> Ubah Status</button>
                        <button class="btn btn-danger btn-sm" onclick="deleteDivisi('${liIzin.no}')"><i class="fas fa-trash"></i></button>
                    </td>
                `;
                tableBody.appendChild(row);
            });
        ...
        .then(data => {
            ...
            data.forEach((liLembur) => {
                ...
                row.innerHTML = `
                    ...
                    <td>
                        <button class="btn btn-warning btn-sm" onclick="ubahStatusLembur(${liLembur.no})"><i class="fas fa-edit"></i> Ubah Status</button>
                    </td>
                `;
                tableBody.appendChild(row);
            });
